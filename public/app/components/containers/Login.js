									...
									<div className="panel-body" style={{padding:40}}>
										<form id="login-form" name="login-form" className="nobottommargin" action="#" method="post">
											...
											<div className="col_full">
												...
												<input onChange={this.updateCurrentUser} type="text" id="userName" name="login-form-username" value={this.state.currentUser.userName} className="form-control not-dark" />
											</div>
